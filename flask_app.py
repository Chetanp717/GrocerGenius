...
try:
    model = joblib.load('/home/chetan/Downloads/Infosys/best_xgb_model.pkl')
    scaler = joblib.load('/home/chetan/Downloads/Infosys/scaler.pkl')
    standard_scaler = joblib.load('/home/chetan/Downloads/Infosys/standard_scaler.pkl')
    yeo_johnson = joblib.load('/home/chetan/Downloads/Infosys/yeo_johnson.pkl')
    one_hot_encoder = joblib.load('/home/chetan/Downloads/Infosys/one_hot_encoder.pkl')
    ordinal_encoder = joblib.load('/home/chetan/Downloads/Infosys/ordinal_encoder.pkl')

    item_weight_medians = joblib.load('/home/chetan/Downloads/Infosys/item_weight_medians.pkl')
    outlet_size_modes = joblib.load('/home/chetan/Downloads/Infosys/outlet_size_modes.pkl')
    median_visibility = joblib.load('/home/chetan/Downloads/Infosys/median_visibility.pkl')
    loo_encodings = joblib.load('/home/chetan/Downloads/Infosys/loo_encodings.pkl')
